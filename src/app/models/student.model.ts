...
export class Student {
    ...
    houseAllocated: House;
    school: School;
    createdAt: string;
    updatedAt: string;
    dateTimeAdmitted: string;

    constructor(payload?: Student) {
        this.id = payload?.id || '';
        ...
        this.addressOfLastSchoolAttended = payload?.addressOfLastSchoolAttended || '';
        ...
        this.residentialAddressOfGuardian = payload?.residentialAddressOfGuardian || '';
        ...
        this.houseAllocated = payload?.houseAllocated || {} as House;
        this.school = payload?.school || {} as School;
